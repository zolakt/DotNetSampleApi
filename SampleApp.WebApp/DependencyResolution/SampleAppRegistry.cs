...
using SampleApp.WebApp.Configuration;
using StructureMap.Configuration.DSL;
using StructureMap.Graph;
using SampleApp.WebApp.JsonValidationMapper;

namespace SampleApp.WebApp.DependencyResolution
{
    public class SampleAppRegistry : Registry
    {
        ...
        {
            For<IAppConfig>().Use<WebAppConfig>();
            For<IAppConfig<IServiceConfigOptions>>().Use<WebAppConfig>();
            ...
            For<IJsonValidationMapper>().Use<JQueryValidationMapper>();
        }
